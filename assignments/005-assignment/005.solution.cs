    ...
    class Program
    {
        ...
        static void DisplayAllUserTransactions()
        {
            ...
            if (user != null)
            {
                ...
                Console.WriteLine("\nManagerial Operations:");
                foreach (var transaction in managerialOperations.FindAll(t => t.UserId == user.UserId))
                {
                    Console.WriteLine(transaction);
                }

                Console.WriteLine("\nFinancial Operations:");
                foreach (var transaction in financialOperations.FindAll(t => t.UserId == user.UserId))
                {
                    Console.WriteLine(transaction);
                }
            }
